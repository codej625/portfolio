                ...
                <div className="bg-body-tertiary p-4">
                  ...
                  <div>
                    ...
                    <div className="d-flex mt-2">
                      ...
                      <div className="rounded-5 bg-white p-2 me-2">SQL</div>
                ...
                <div className="bg-body-tertiary p-4">
                  ...
                  <div>
                    <div className="d-flex mt-3">
                      ...
                      <div className="rounded-5 bg-white p-2 me-2">NestJS</div>
                ...
                <div className="d-flex">
                    ...
                    <div className="text-end rounded-5 bg-white p-4">
                      <div className="d-flex justify-content-center">
                        <div className="d-flex flex-column">
                          ...
                          <div className="text-center fs-8 mt-1">공학사 취득</div>
                  ...
                  <article className="ps-4" style={{ width: 250 }}>
                    <div className="text-end rounded-5 bg-white p-4">
                      <div className="d-flex justify-content-center">
                        <div className="d-flex flex-column">
                          <h5 className="text-center m-0 me-2">평생교육진흥원</h5>
                          <div className="text-center fs-8 mt-1">💵 경영 전공</div>
                          <div className="text-center fs-8 mt-1">경영전문학사 취득</div>
                          <div className="text-black-50 fs-8 mt-3">2018.01 ~ 2021.02 졸업</div>
                    ...
                    <div className="text-end rounded-5 bg-white p-4">
                      <div className="d-flex justify-content-center">
                        <div className="d-flex flex-column">
                          ...
                          <div className="text-center fs-8 mt-1">📖 인문 계열</div>
                          <div className="text-center fs-8 mt-1">-</div>
                          <div className="text-black-50 fs-8 mt-3">2007.03 ~ 2010.02 졸업</div>
                          <div className="text-black-50 fs-8">-</div>
                        </div>
                      </div>
                    </div>
                  </article>
