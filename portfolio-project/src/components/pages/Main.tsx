            ...
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-xl leading-8 text-gray-700">
                  "<b>1명의 개발자가 하나의 기업가치를 갖는다</b>"라는 신념을
              ...
              <div className="lg:max-w-lg">
                ...
                <ul role="list" className="mt-8 space-y-8 text-gray-600">
                  <li className="flex gap-x-3">
                    <span>2024.05 ~ 재직중</span>
                    <span>
                      <strong className="font-semibold text-gray-900">3. 나이콤</strong>
                      
                    </span>
                  </li>
                  <li className="flex gap-x-3">
                    <span>2022.01 ~ 2024.04</span>
                    <span>
                      <strong className="font-semibold text-gray-900">2. 엠플랜잇</strong>
                    </span>
                  </li>
                  <li className="flex gap-x-3">
                    <span>2017.09 ~ 2021.01</span>
                    <span>
                      <strong className="font-semibold text-gray-900">1. 컴퓨존</strong>
                    </span>
                  </li>
                </ul>
              </div>
